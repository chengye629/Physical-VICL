...
V7_DIR = PROJECT_ROOT / "scripts/annotation/v7"
V63_DIR = PROJECT_ROOT / "scripts/annotation/v6_3"
BASE_PATH = V63_DIR / "09_run_pass_b_v6_3.py"

sys.path.insert(0, str(SCRIPT_DIR))
sys.path.insert(0, str(V7_DIR))
sys.path.insert(0, str(V63_DIR))
...
def load_base_module():
    spec = importlib.util.spec_from_file_location("pass_b_v6_3_base", BASE_PATH)
...
def main() -> None:
    ...
    for row in tqdm(rows, desc="Pass B v7 alpha3"):
